...
CREATE TABLE IF NOT EXISTS reconciliation_results (
    ...
    gstr2b_invoice_id UUID REFERENCES normalized_gstr2b_invoices(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS reconciliation_status (
    ...
    workspace_id UUID NOT NULL REFERENCES workspaces(id) ON DELETE CASCADE,
    tenant_id UUID NOT NULL REFERENCES tenants(id) ON DELETE CASCADE,
    gstr_data_id UUID REFERENCES normalized_gstr2b_invoices(id) ON DELETE CASCADE,
    gstr_type VARCHAR(20),
    book_data_type VARCHAR(20),
    book_data_id UUID REFERENCES purchase_vouchers(id) ON DELETE CASCADE,
