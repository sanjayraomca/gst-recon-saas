...
class NormalizedGstr2bModel {
    ...
    static mapB2B(records, { tenantId, workspaceId, importFilingId, returnPeriod, sourceTable }) {
        return records.map(r => ({
            ...
            document_number_clean: r.invoice_number || null,
            document_date: r.invoice_date || null,
            document_value: (r.invoice_value !== undefined && r.invoice_value !== null && r.invoice_value !== '') ? r.invoice_value : null,
            taxable_value: (r.taxable_value !== undefined && r.taxable_value !== null && r.taxable_value !== '') ? r.taxable_value : null,
    ...
    static mapB2BA(records, { tenantId, workspaceId, importFilingId, returnPeriod, sourceTable }) {
        return records.map(r => ({
            ...
            place_of_supply: r.place_of_supply || null,
            reverse_charge: r.reverse_charge === 'Yes',
            document_number_clean: r.revised_invoice_number || null,
    ...
    static mapCDNR(records, { tenantId, workspaceId, importFilingId, returnPeriod, sourceTable }) {
        return records.map(r => {
            ...
            return {
                ...
                place_of_supply: r.place_of_supply || null,
                reverse_charge: r.reverse_charge === 'Yes',
                document_number_clean: r.note_number || null,
                document_date: r.note_date || null,
                document_value: (r.note_value !== undefined && r.note_value !== null && r.note_value !== '') ? r.note_value : null,
                original_invoice_number: r.original_invoice_number || null,
                original_invoice_date: r.original_invoice_date || null,
                taxable_value: (r.taxable_value !== undefined && r.taxable_value !== null && r.taxable_value !== '') ? r.taxable_value : null,
                igst: r.integrated_tax || 0,
    ...
    static mapCDNRA(records, { tenantId, workspaceId, importFilingId, returnPeriod, sourceTable }) {
        return records.map(r => {
            ...
            return {
                ...
                place_of_supply: r.place_of_supply || null,
                reverse_charge: r.reverse_charge === 'Yes',
                document_number_clean: r.revised_note_number || null,
    ...
    static mapIMPG(records, { tenantId, workspaceId, importFilingId, returnPeriod, sourceTable }) {
        return records.map(r => ({
            ...
            document_number_clean: r.boe_number || null,
            document_date: r.boe_date || null,
            document_value: (parseFloat(r.taxable_value) || 0) + (parseFloat(r.integrated_tax) || 0) + (parseFloat(r.cess) || 0),
    ...
    static mapISD(records, { tenantId, workspaceId, importFilingId, returnPeriod, sourceTable }) {
        return records.map(r => ({
            ...
            document_number_clean: r.document_number || null,
            document_date: r.document_date || null,
            document_value: (parseFloat(r.integrated_tax) || 0) + (parseFloat(r.central_tax) || 0) + (parseFloat(r.state_ut_tax) || 0) + (parseFloat(r.cess) || 0),
